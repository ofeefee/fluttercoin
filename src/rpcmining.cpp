...
Value getstakinginfo(const Array& params, bool fHelp)
{
    ...
    obj.push_back(Pair("stakeinterest",    (uint64_t)GetProofOfStakeReward(0, 0, GetLastBlockIndex(pindexBest, true)->nBits, GetLastBlockIndex(pindexBest, true)->nTime, true)));
